...
function Calendar({
  ...
  return (
    <DayPicker
      ...
      className={cn(
        "group/calendar bg-background w-full border-collapse p-2 [--cell-radius:var(--radius-md)] [--cell-size:--spacing(7)] in-data-[slot=card-content]:bg-transparent in-data-[slot=popover-content]:bg-transparent",
      ...
      components={{
        ...
        DayButton: useMemo(
          () =>
            ({ ...props }) => <CalendarDayButton locale={locale} {...props} />,
          [locale],
        ),
        WeekNumber: useMemo(
          () =>
