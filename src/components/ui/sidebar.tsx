...
function SidebarProvider({
  ...
  const [_open, _set_open] = React.useState(defaultOpen);
  ...
  const toggle_sidebar = React.useCallback(() => {
    return is_mobile
      ? set_open_mobile((prev_open) => !prev_open)
      : set_open((prev_open) => !prev_open);
  }, [is_mobile, set_open, set_open_mobile]);
  ...
  const context_value = React.useMemo<SidebarContextProps>(
    () => ({
      state,
      open,
      setOpen: set_open,
      isMobile: is_mobile,
      openMobile: open_mobile,
      setOpenMobile: set_open_mobile,
  ...
  return (
    <SidebarContext value={context_value}>
      <div
...
function SidebarMenuButton({
  ...
  } & VariantProps<typeof sidebar_menu_button_variants>): React.JSX.Element {
