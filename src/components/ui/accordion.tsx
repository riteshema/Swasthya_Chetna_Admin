...
function Accordion({ className, ...props }: AccordionPrimitive.Root.Props):JSX.Element {
  return (
...
function AccordionItem({ className, ...props }: AccordionPrimitive.Item.Props):JSX.Element {
  return (
